/* منسوخ كما هو من docs/units-art.js (المرجع الإلزامي للقسم 13)
   لا تُعدّل أرقامه ولا رسمه هنا؛ عدّل المرجع ثم أعد النسخ.
   السطر الأخير فقط هو المتغيّر: تصدير ES بدل module.exports */
