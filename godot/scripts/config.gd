...
# ---------- أرض الخريطة (14) ----------
# الأرض كلها في MultiMesh واحد: أمرا رسم بدل نحو 1600 على الخريطة الكبيرة.
# اجعلها false لترجع الأرض إلى الرسم مربعاً مربعاً (للمقارنة أو عند خلل).
const GROUND_MM := true
const GROUND_EDGE := 0.6            # عرض حدّ المربع الذي يمنع الفراغ بين المربعات
# علامة منتصف الشارع: نصف طولها أفقياً ورأسياً، وعرضها ولونها
const DASH_DX := 4.0
const DASH_DY := 2.0
const DASH_W := 1.0
const DASH_COL := Color("c9bd85")
