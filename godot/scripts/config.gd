...
# جودة تلقائية للأجهزة الضعيفة (14): شيدر الإضاءة تحسين شكل لا قاعدة لعب، فهو
# أول ما يُضحّى به إن لم يبلغ الجهاز المعدل المطلوب، ويرجع إن تحسّن الأداء.
const QUALITY_CHECK := 2.0      # كل كم ثانية يُراجَع معدل الإطارات
const QUALITY_LOW_FPS := 26.0   # تحته يُطفأ شيدر الإضاءة
const QUALITY_BACK_FPS := 45.0  # وفوقه يرجع
const QUALITY_BACK_TIMES := 3   # بعد ثلاث مراجعات متتالية، منعاً للتذبذب
